La programation orientée objet (POO), permet une programation plus sure (en encapsulant des données) et plus rapide (en promouvant la réutilisation du code existant).
