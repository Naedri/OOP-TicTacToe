...
/*
 * package contenant les élements + necessaires, + communs, pour permettre aux
 * applis de lancer une partie
 * 
 * il y a : + Interface.java : + permet de selectionner de manizre securisee une
 * cellule + contient les messages necessaires à l'interface dans les
 * differentes appli + messageTour s affiche a chaque debut de tour indiquant
 ...
 * s'affiche à chaque jeton place indiquant quelle cellule a été choisie +
