...
public class Utils_Grille_Evaluation_Forme {
	...
	public static int[][] getCoordForme(int ligne, int colonne, CA_Grille grille, Forme forme) {
		...
		assert (Utils_Grille_Evaluation_Forme.existeForme(ligne, colonne, grille, forme));
	...
	public static String getJetonForme(int ligne, int colonne, CA_Grille grille, Forme forme) {
		...
		int[][] coordDesJetons = Utils_Grille_Evaluation_Forme.getCoordForme(ligne, colonne, grille, forme);
