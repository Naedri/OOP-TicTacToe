...
public enum Forme {
	...
	CARRE("carre", new int[] { 1, 1, 1, 1 }, new int[] { 2, 4, 6, 0 },
			new int[][] { { 0, 1, 2, 1, 1 }, { 1, 2, 1, 0, 1 } },
			new int[][] { { 1, 2 }, { 1, 4 }, { 1, 6 }, { 1, 0 } }),
	LOSANGE("losange", new int[] { 1, 1, 1, 1 }, new int[] { 1, 3, 5, 7 },
			new int[][] { { 0, 1, 2, 1 }, { 1, 2, 1, 0 } }, new int[][] { { 1, 1 }, { 1, 3 }, { 1, 5 }, { 1, 7 } }),
	CROIX("croix", new int[] { 1, 1, 1, 1, 1 }, new int[] { 1, 3, 5, 7, 6 },
			new int[][] { { 0, 1, 2, 1, 1 }, { 1, 2, 1, 0, 1 } },
			new int[][] { { 1, 1 }, { 1, 3 }, { 1, 5 }, { 1, 7 }, { 1, 6 } });
